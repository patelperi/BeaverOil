...
Public Class rpt_TransportersList
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_TransportersList.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rpt_TransportersList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_TransportersList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_TransportersList = New rpt_TransportersList
        rpt.Site = Me.Site
        Return rpt
    End Function

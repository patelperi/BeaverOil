...
Public Class rpt_JobActivity
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rpt_JobActivity.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_JobActivity
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_JobActivity = New rpt_JobActivity
        rpt.Site = Me.Site
        Return rpt
    End Function

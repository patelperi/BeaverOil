...
Public Class rpt_FacilitiesList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rpt_FacilitiesList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_FacilitiesList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_FacilitiesList = New rpt_FacilitiesList
        rpt.Site = Me.Site
        Return rpt
    End Function

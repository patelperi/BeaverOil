...
Public Class rpt_NonHazardous
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rpt_NonHazardous.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_NonHazardous
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_NonHazardous = New rpt_NonHazardous
        rpt.Site = Me.Site
        Return rpt
    End Function

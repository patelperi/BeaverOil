...
Public Class rpt_ProductsList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rpt_ProductsList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ProductsList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ProductsList = New rpt_ProductsList
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rpt_Receivables
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rpt_Receivables.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Receivables
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Receivables = New rpt_Receivables
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rpt_VendorsList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rpt_VendorsList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_VendorsList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_VendorsList = New rpt_VendorsList
        rpt.Site = Me.Site
        Return rpt
    End Function

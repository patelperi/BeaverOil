...
Public Class rptReceiptControl
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rptReceiptControl.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReceiptControl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceiptControl = New rptReceiptControl
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptMWRDReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rptMWRDReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMWRDReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMWRDReport = New rptMWRDReport
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rpt_GeneratorsList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rpt_GeneratorsList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_GeneratorsList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_GeneratorsList = New rpt_GeneratorsList
        rpt.Site = Me.Site
        Return rpt
    End Function

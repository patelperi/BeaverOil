...
Public Class rptAttachmentC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rptAttachmentC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAttachmentC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAttachmentC = New rptAttachmentC
        rpt.Site = Me.Site
        Return rpt
    End Function

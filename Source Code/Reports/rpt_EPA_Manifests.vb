...
Public Class rpt_EPA_Manifests
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rpt_EPA_Manifests.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_EPA_Manifests
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_EPA_Manifests = New rpt_EPA_Manifests
        rpt.Site = Me.Site
        Return rpt
    End Function

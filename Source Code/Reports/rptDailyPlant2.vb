...
Public Class rptDailyPlant2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rptDailyPlant2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDailyPlant2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDailyPlant2 = New rptDailyPlant2
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptAccounting
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rptAccounting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAccounting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAccounting = New rptAccounting
        rpt.Site = Me.Site
        Return rpt
    End Function

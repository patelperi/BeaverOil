...
Public Class rptNonHazardous
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rptNonHazardous.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNonHazardous
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNonHazardous = New rptNonHazardous
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rpt_InvoiceList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rpt_InvoiceList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_InvoiceList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_InvoiceList = New rpt_InvoiceList
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rpt_P2Manifests_new
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_P2Manifests_new.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rpt_P2Manifests_new.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_P2Manifests_new
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_P2Manifests_new = New rpt_P2Manifests_new
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptDailyHazNonHaz
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rptDailyHazNonHaz.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDailyHazNonHaz
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDailyHazNonHaz = New rptDailyHazNonHaz
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rpt_PayableCheck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BeaverOil.rpt_PayableCheck.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_PayableCheck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_PayableCheck = New rpt_PayableCheck
        rpt.Site = Me.Site
        Return rpt
    End Function
